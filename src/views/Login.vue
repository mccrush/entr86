        ...
        <div class="row">
          <div class="col-12 text-left">
            <form @submit.prevent="login" class>
              ...
              <br />
              <input type="text" class="form-control form-control-sm" id="email" required v-model="email"
                placeholder="example@mail.ru" />
              <br />
              <label for="password">Password</label>
              <div class="input-group">
                <input :type="passType ? 'password' : 'text'" class="form-control form-control-sm" id="password"
                  required v-model="password" ref="pass" maxlength="20" />
                <div class="input-group-append">
                  <button class="btn btn-light p-0 pl-2 pr-2 border" type="button" @click="passType = !passType">
                    <img v-if="passType" src="@/assets/icons/eye-slash.svg" width="24" height="24" alt="Показать пароль"
                      class="opacity-06" />
                    <img v-else src="@/assets/icons/eye.svg" width="24" height="24" alt="Скрыть пароль"
                      class="opacity-06" />
                  </button>
                </div>
              </div>
