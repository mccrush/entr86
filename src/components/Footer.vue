  ...
  <div class="bg-dark">
    <div class="container">
      <div class="row text-light text-start">
        <div class="col-12 col-sm-6 pt-3 pb-3">
          ...
          <p class="mb-2">
            ООО ЭНТР 628415,
            <br />Тюменская область <br />ХМАО-Югра г.&nbsp;Сургут, <br />ул.
            Инженерная 1/4 <br />+7 3462 630 475 <br />entr86@mail.ru
          </p>
    ...
    <div class="bg-black" style="background: #00000080">
      <div class="container d-flex justify-content-between">
        <div class="text-light copy pt-1 pb-1">© 2024 entr86.ru</div>
