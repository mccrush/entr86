    ...
    <div class="col-12">
      ...
      <Editor
        ...
        :init="{
          ...
          plugins:
            'anchor autolink charmap codesample emoticons image link lists media searchreplace table visualblocks code wordcount',
          toolbar:
            'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table | align lineheight | numlist bullist indent outdent | emoticons charmap | removeformat | tools',
          menu: {
...
export default {
  ...
  methods: {
    ...
    saveItem() {
      this.$store.dispatch('updateItem', { item: this.doc })
    },
    async removeImage() {
      return
